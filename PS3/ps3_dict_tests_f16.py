...
class ps3_P1A(unittest.TestCase):
    ...
    def test_unimplemented_methods(self):
        ...
        room = ps3_dict.RectangularRoom(2,2,1)
    ...
    def test_room_dirt_dirty(self):
        ...
        room = ps3_dict.RectangularRoom(width, height, dirt_amount)
...
class ps3_P1B(unittest.TestCase):
    ...
    def test_getset_robot_direction(self):
        ...
        robots = [ps3_dict.Robot(solution_room, 1.0, 1) for i in range(4)]
...
class ps3_P2_ER(unittest.TestCase):
    ...
    def test_get_random_position(self):
        ...
        room = ps3_dict.EmptyRoom(width, height, dirt_amount)
    ...
    def test_get_num_tiles(self):
        ...
        for i in range(10):        
            ...
            room_num_tiles = ps3_dict.EmptyRoom(width, height, dirt_amount).get_num_tiles()
            sol_room_tiles = ps3_dict.EmptyRoom(width, height, dirt_amount).get_num_tiles()
...
class ps3_P2_FR(unittest.TestCase):                  
    ...
    def test_is_tile_furnished(self):
        ...
        for trial in range(5):
            ...
            room = ps3_dict.FurnishedRoom(width, height, dirt_amount)
    ...
    def test_get_num_tiles(self):
        ...
        for i in range(10):        
            ...
            sol_room = ps3_dict.FurnishedRoom(width, height, dirt_amount)
            sol_room.furniture_tiles = room.furniture_tiles
            # generate answers
...
class ps3_P3(unittest.TestCase):
    ...
    def createRoomAndRobots(self, num_robots):
        r = ps3_dict.EmptyRoom(5, 7, 1)
        robots = [ps3_dict.StandardRobot(r, 1.0, 1) for i in range(num_robots)]
        return r, robots
    ...
    def test_update_position_and_cleanStandardRobot(self):
        ...
        r = ps3_dict.EmptyRoom(3, 5, 1)
        robot = ps3_dict.StandardRobot(r, 1.0, 1)
        ...
        self.assertTrue(robotPos.get_x() == correctPos.get_x() and robotPos.get_y() == correctPos.get_y(),
                          ...
                          (ps3_dict.Position(2.5, 2.5), robot.get_robot_position()))
...
class SimulationThread(threading.Thread):
    ...
    def run(self):
        try:
            self.result = ps3_dict.run_simulation(*self.args)
        except Exception:
...
class ps3_P5_Standard(SimulationTester):
    ...
    def testSimulation1(self):
        ...
        try:
            self.run_simulation(((142, 173),), (1, 1.0, 1, 5, 5, 1, 1.0, 100, ps3_dict.StandardRobot))
        except:
            print ("Unexpected error:", sys.exc_info()[1])
            raise
    def testSimulation2(self):
        "Test cleaning 75% of a 10x10 room (Standard Robot)"
        self.run_simulation(((183, 198),), (1, 1.0, 1, 10, 10, 1, 0.75, 100, ps3_dict.StandardRobot))
    def testSimulation3(self):
        "Test cleaning 90% of a 10x10 room (Standard Robot)"
        self.run_simulation(((298, 327),), (1, 1.0, 1, 10, 10, 1, 0.9, 100, ps3_dict.StandardRobot))
    def testSimulation4(self):
        "Test multiple robots (95% of a 20x20 room with 5 robots (Standard Robot))"
        self.run_simulation(((289, 303),), (5, 1.0, 1, 20, 20, 1, 0.95, 100, ps3_dict.StandardRobot))
    def testSimulation5(self):
        "Test different speeds (90% of a 5x20 room with a robot of speed 0.2 (Standard Robot))"
        self.run_simulation(((1095, 1228),), (1, 0.2, 1, 5, 20, 1, 0.9, 100, ps3_dict.StandardRobot))
    def testSimulation6(self):
        ...
        self.run_simulation(((155, 180),), (3, 0.5, 1, 10, 10, 1, 0.9, 100, ps3_dict.StandardRobot))
    # new tests below here
    def testSimulation7(self):
         "Test cleaning 100% of a 5x5 room (Standard Robot, 5 dirt/tile, capcity = 3)"
         self.run_simulation(((206, 266),(180, 240)), (1, 1.0, 3, 5, 5, 5, 1.0, 100, ps3_dict.StandardRobot))
    def testSimulation8(self):
        "Test cleaning 100% of a 5x5 room (Standard Robot, 6 dirt/tile, capacity = 3)"
        self.run_simulation(((206, 266),(180, 240)), (1, 1.0, 3, 5, 5, 6, 1.0, 100, ps3_dict.StandardRobot))
    def testSimulation9(self):
        ...
        self.run_simulation(((387, 447),(384, 444)), (1, 0.2, 2, 3, 10, 6, 0.9, 100, ps3_dict.StandardRobot))
    def testSimulation10(self):
        "Test multiple robots (95% of a 10x10 room with 5 robots (Standard Robot)) capacity = 2, 6 dirt/tile"
        self.run_simulation(((137, 198),(130, 190)), (5, 1.0, 2, 10, 10, 6, 0.95, 100, ps3_dict.StandardRobot))
    def testSimulation11(self):
        ...
        self.run_simulation(((48, 108), (45, 104)), (3, 0.5, 2, 5, 5, 6, 0.9, 100, ps3_dict.StandardRobot))
...
class ps3_P5_Faulty(SimulationTester):
    ...
    def testSimulation1(self):
        ...
        x = ps3_dict.run_simulation(1, 1.0, 1, 5, 5, 1, 1.0, 100, ps3_dict.FaultyRobot)
        self.assertTrue(125 <= x <= 275,
                        "Simulation output was outside of 99.7% confidence interval!\n")    
    def testSimulation2(self):
        "Test cleaning 75% of a 10x10 room with FaultyRobot"
        x = ps3_dict.run_simulation(1, 1.0, 1, 10, 10, 1, 0.75, 100, ps3_dict.FaultyRobot)
